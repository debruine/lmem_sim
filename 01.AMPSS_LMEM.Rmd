...
my_lmer_power(nitem = c(ingroup = 50, outgroup = 50), b1 = 20) %>%
  apa_table(digits = c(0,0,0,2,1,1,1,3),
            align = "lllrrrrr",
            caption="The output of lmer_power(nitem = c(ingroup = 50, outgroup = 50), b1 = 20).",
            placement = "H")
```
...
`r apa_print(a_subj)$table %>% apa_table(placement = "H")`
...
`r apa_print(a_item)$table %>% apa_table(placement = "H")`
