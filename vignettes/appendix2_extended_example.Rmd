...
```{r, eval = FALSE, include = FALSE}
  ...
  b0           = 800, # grand mean
  b1           =  50, # main effect of category
  b2           =   0, # main effect of expression
  b3           =  70, # interaction between category and expression
  omega_0      =  80, # by-item random intercept sd
  omega_1      =  60, # by-item random slope for exp
  omega_r      = 0.2, # by-item random effect correlation
  tau_0        = 100, # by-subject random intercept sd
  tau_1        =  40, # by-subject random slope sd for category
  tau_2        =  80, # by-subject random slope sd for exp
  tau_3        =  80, # by-subject random slope sd for category*exp
  # by-subject random effect correlations
  tau_r        = c(.3, .3, .3,   # S0s  * cat, exp, tc
                       .1, .1,   # cat  *      exp, tc
                           .1),  # exp *            tc
